...
void LIVMapper::readParameters(rclcpp::Node::SharedPtr &node)
{
  ...
  this->node->declare_parameter<int>("width", 1280);
  this->node->declare_parameter<int>("height", 1024);
  this->node->declare_parameter<double>("scale", 1.0);
  this->node->declare_parameter<double>("fx", 1293.56944);
  this->node->declare_parameter<double>("fy", 1293.3155);
  this->node->declare_parameter<double>("cx", 626.91359);
  this->node->declare_parameter<double>("cy", 522.799224);
